...
function preload() {
  glassImg      = loadImage('assets/time-tank/glass.png');
  sandImg       = loadImage('assets/time-tank/sandy-bottom.png');
  bigFishImg    = loadImage('assets/time-tank/big-fish.png');
  shrimpImg     = loadImage('assets/time-tank/shrimp.png');
  bigRockImg    = loadImage('assets/time-tank/big-rock.png');
  tinyBubbleImg = loadImage('assets/time-tank/tiny-bubble.png');
  regBubbleImg  = loadImage('assets/time-tank/reg-bubble.png');
  bigBubbleImg  = loadImage('assets/time-tank/big-bubble.png');
  statueImg     = loadImage('assets/time-tank/statue.png');
}
